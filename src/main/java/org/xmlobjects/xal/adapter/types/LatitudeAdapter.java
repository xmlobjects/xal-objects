...
public class LatitudeAdapter implements ObjectBuilder<Latitude>, ObjectSerializer<Latitude> {

    @Override
    public Latitude createObject(QName name, Object parent) throws ObjectBuildException {
        return new Latitude();
    }

    @Override
    public void initializeObject(Latitude object, QName name, Attributes attributes, XMLReader reader) throws ObjectBuildException, XMLReadException {
    ...
    @Override
    public void initializeElement(Element element, Latitude object, Namespaces namespaces, XMLWriter writer) throws ObjectSerializeException, XMLWriteException {
