...
public class MailStopNumberAdapter implements ObjectBuilder<Identifier>, ObjectSerializer<Identifier> {
    ...
    public void initializeObject(Identifier object, QName name, Attributes attributes, XMLReader reader) throws ObjectBuildException, XMLReadException {
        ...
        attributes.getValue("NameNumberSeparator").ifPresent(v -> object.getOtherAttributes().add("NameNumberSeparator", v));
    ...
    public void initializeElement(Element element, Identifier object, Namespaces namespaces, XMLWriter writer) throws ObjectSerializeException, XMLWriteException {
        ...
        element.addAttribute("NameNumberSeparator", object.getOtherAttributes().getValue("NameNumberSeparator"));
