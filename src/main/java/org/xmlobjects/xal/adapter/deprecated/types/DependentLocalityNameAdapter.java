...
public class DependentLocalityNameAdapter implements ObjectBuilder<SubLocalityName>, ObjectSerializer<SubLocalityName> {
    ...
    @Override
    public void initializeElement(Element element, SubLocalityName object, Namespaces namespaces, XMLWriter writer) throws ObjectSerializeException, XMLWriteException {
