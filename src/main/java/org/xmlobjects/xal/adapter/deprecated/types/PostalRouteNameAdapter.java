...
public class PostalRouteNameAdapter implements ObjectBuilder<ThoroughfareName>, ObjectSerializer<ThoroughfareName> {

    @Override
    public ThoroughfareName createObject(QName name, Object parent) throws ObjectBuildException {
        return new ThoroughfareName(ThoroughfareNameType.NAME_ONLY);
    }
