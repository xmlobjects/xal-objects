...
public class ThoroughfareNameAdapter implements ObjectBuilder<ThoroughfareName>, ObjectSerializer<ThoroughfareName> {
    ...
    @Override
    public ThoroughfareName createObject(QName name) throws ObjectBuildException {
    ...
    @Override
    public Element createElement(ThoroughfareName object, Namespaces namespaces) throws ObjectSerializeException {
        return Element.of(XALConstants.XAL_2_0_NAMESPACE, "ThoroughfareName");
    }
