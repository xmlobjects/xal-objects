...
@XMLElement(name = "AddressLine", namespaceURI = XALConstants.XAL_2_0_NAMESPACE)
public class AddressLineAdapter implements ObjectBuilder<AddressLine>, ObjectSerializer<AddressLine> {

    @Override
    public AddressLine createObject(QName name) throws ObjectBuildException {
    ...
    @Override
    public Element createElement(AddressLine object, Namespaces namespaces) throws ObjectSerializeException {
        return Element.of(XALConstants.XAL_2_0_NAMESPACE, "AddressLine");
    }
