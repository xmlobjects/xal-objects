...
public class PremiseNumberRangeToAdapter implements ObjectBuilder<PremiseNumberRangeTo>, ObjectSerializer<PremiseNumberRangeTo> {

    @Override
    public PremiseNumberRangeTo createObject(QName name) throws ObjectBuildException {
        return new PremiseNumberRangeTo();
    }

    @Override
    public void buildChildObject(PremiseNumberRangeTo object, QName name, Attributes attributes, XMLReader reader) throws ObjectBuildException, XMLReadException {
    ...
    @Override
    public Element createElement(PremiseNumberRangeTo object, Namespaces namespaces) throws ObjectSerializeException {
        return Element.of(XALConstants.XAL_2_0_NAMESPACE, "PremiseNumberRangeTo");
    }

    @Override
    public void writeChildElements(PremiseNumberRangeTo object, Namespaces namespaces, XMLWriter writer) throws ObjectSerializeException, XMLWriteException {
