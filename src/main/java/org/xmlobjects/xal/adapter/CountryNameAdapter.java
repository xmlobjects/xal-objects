...
@XMLElement(name = "CountryName", namespaceURI = XALConstants.XAL_2_0_NAMESPACE)
public class CountryNameAdapter implements ObjectBuilder<CountryName>, ObjectSerializer<CountryName> {

    @Override
    public CountryName createObject(QName name) throws ObjectBuildException {
    ...
    public Element createElement(CountryName object, Namespaces namespaces) throws ObjectSerializeException {
        return Element.of(XALConstants.XAL_2_0_NAMESPACE, "CountryName");
    }
