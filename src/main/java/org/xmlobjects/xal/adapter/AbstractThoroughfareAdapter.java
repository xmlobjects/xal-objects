...
import org.xmlobjects.xal.adapter.types.ThoroughfareNameAdapter;
...
public abstract class AbstractThoroughfareAdapter<T extends AbstractThoroughfare> extends AddressObjectAdapter<T> {
    ...
    public void initializeObject(T object, QName name, Attributes attributes, XMLReader reader) throws ObjectBuildException, XMLReadException {
        ...
        attributes.getValue(XALConstants.XAL_3_0_NAMESPACE, "TypeCode").collapse().ifPresent(object::setTypeCode);
        ...
        if (XALConstants.XAL_3_0_NAMESPACE.equals(name.getNamespaceURI())) {
            switch (name.getLocalPart()) {
                case "NameElement":
                    ...
                    break;
                case "Number":
                    object.getNameElementOrNumber().add(new ThoroughfareNameOrNumber(reader.getObjectUsingBuilder(IdentifierAdapter.class)));
                    break;
            }
        }
    }
    ...
    public void initializeElement(Element element, T object, Namespaces namespaces, XMLWriter writer) throws ObjectSerializeException, XMLWriteException {
        ...
        element.addAttribute(XALConstants.XAL_3_0_NAMESPACE, "TypeCode", TextContent.of(object.getTypeCode()).collapse());
